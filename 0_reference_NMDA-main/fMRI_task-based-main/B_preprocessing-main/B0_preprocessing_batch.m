...
clear all
close all
addpath('C:\Users\45040\Documents\MATLAB\ana_test\NMDA-main\fMRI_task-based-main\B_preprocessing-main')
...
addpath(genpath('C:\Users\45040\Documents\MATLAB\ana_test\hMRI-toolbox-0.4.0'))
% addpath(genpath('C:\Users\saraw\Desktop\BA\EXPRA2019_HIVR\Toolboxes\DPABI_V5.1_201201'))
addpath('C:\Users\45040\Documents\MATLAB\ana_test\spm12')

%SPM-path
SPM_path  = 'C:\Users\45040\Documents\MATLAB\ana_test\spm12';

%data source directory
src_dir      = 'C:\Users\45040\Documents\MATLAB\ana_test\MoAEpilot';
...
sessNum = 0;
if exist([src_dir filesep SJs{1} filesep 'ses-1'])==7 % 7 = code for directory
...
analysis_switch = [4]; %1 4 3 5 7 8 9
start_prefix=''; %'gf4d'; %ohne artrepair

%no meta data reading
            ...
            for sj = 1:numel(SJs)
                if ismember(sj, excludeSJ)
                    ...
                    if exist([src_dir filesep SJs{sj} filesep 'func' filesep runs{sj, r}])
                        ...
                        funcPath = [src_dir filesep SJs{sj} filesep 'func' filesep];
                        run_dir = fullfile(funcPath);
                        for r = 1:size(runs, 2)
                            run_files{r} = spm_select('List',run_dir,['^' currPrefix runs{sj, r}]);
                        end
                        B4_Realignment_all_runs(funcPath, run_files);
